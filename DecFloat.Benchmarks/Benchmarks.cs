...
public class Benchmarks {
    ...
    private static readonly DecFloat three = new("3");
    ...
    private static readonly DecFloat threeOneFour = new("3.14");
    ...
    private static readonly DecFloat five = new("5");
    ...
    private static readonly DecFloat twentyTwo = new("22");
    private static readonly DecFloat seven = new("7");
